            ...
            <div class="card">
                <form action="" method="get">
                    <div class="card-header">
                        <a onclick="window.location.href = '{{ route('admin.products.index') }}' "
                            ...
                            @if ($products->isNotEmpty())
                                @foreach ($products as $product)
                                    <tr>
                                        <td>{{ $product->id }}</td>
                                        <td>
                                            @if (!empty($product->product_images[0]->image))
                                                <img src="{{ asset('uploads/products/' . $product->product_images[0]->image) }}"
