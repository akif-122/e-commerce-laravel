...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form method="post" name="editBrandForm" id="editBrandForm">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="id" id="id" value="{{ $brand->id }}" class="form-control" ?>
    ...
    <script>
        ...
        $("#editBrandForm").submit(function(e) {
            ...
            $.ajax({
                ...
                type: "put",
                data: $("#editBrandForm").serializeArray(),
                dataType: "json",
